...
class UpdatePostRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'name_c' => ['required', 'string', 'max:25', `unique:posts,name_p, $postId`],
            'fecha_c' => ['nullable'],
            'workers.*.name_w' => ['required', 'string', 'max:25', `unique:comments,name_c, $postId`],
            'workers.*.ci_w' => ['required', 'integer', 'min_digits:11', `unique:comments,nro_ident, $postId`],
            // "nro_c"  => 'required|integer|min:1|unique:posts,nro_contract,'. $postId,
